 ...
 */
console.log("0 == false", 0 == false); //ok
console.log("0 === false", 0 === false); //ok
console.log('"false" == false', "false" == false); //ok
console.log('"0" == 0', "0" == 0); //ok
console.log('Boolean("0") === false', Boolean("0") === false); //ok
console.log("Boolean(0) === false", Boolean(0) === false); //ok
console.log("!Boolean(0) === false", !Boolean(0) === false); //ok
console.log("-1 == false", -1 == false); //ok
console.log("!10 === false", !10 === false); //ok
